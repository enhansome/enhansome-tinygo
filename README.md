...
* [protobuf-go-lite](https://github.com/aperturerobotics/protobuf-go-lite) ⭐ 62 | 🐛 1 | 🌐 Go | 📅 2026-08-19 - Reflection-free Protobuf for Go.
...
* [Go Bluetooth](https://github.com/tinygo-org/bluetooth) ⭐ 989 | 🐛 129 | 🌐 C | 📅 2026-08-04 - Go Bluetooth is a cross-platform package for using Bluetooth Low Energy hardware from the Go programming language.
