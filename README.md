...
A curated list of awesome TinyGo projects. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 180,917 | 🐛 207 | 🌐 Go | 📅 2026-08-11.
...
* [TinyDraw](https://github.com/tinygo-org/tinydraw) ⭐ 52 | 🐛 2 | 🌐 Go | 📅 2025-12-19 - Draw primitives on TinyGo displays. It is heavily based on the Adafruit GFX library.
...
* [TinyGo Drivers](https://github.com/tinygo-org/drivers) ⭐ 744 | 🐛 159 | 🌐 Go | 📅 2026-08-10 - Provides a collection of hardware drivers for devices such as sensors and displays that can be used together with TinyGo.
...
* [pio](https://github.com/tinygo-org/pio) ⭐ 50 | 🐛 11 | 🌐 Go | 📅 2026-08-03 - Programmable I/O API for RP2040/RP2350 using TinyGo
...
* [gomavlib](https://github.com/bluenviron/gomavlib) ⭐ 194 | 🐛 3 | 🌐 Go | 📅 2026-08-12 - Mavlink protocol (2.0 and 1.0) implementation in Go for control and instrumentation of autonomous vehicles.
* [mlkem768](https://github.com/FiloSottile/mlkem768) ⭐ 191 | 🐛 0 | 🌐 Go | 📅 2026-02-14 - Quantum-resistant key encapsulation method ML-KEM (formerly known as Kyber) implementation in Go.
...
* [gjson](https://github.com/tidwall/gjson) ⭐ 15,551 | 🐛 100 | 🌐 Go | 📅 2026-05-14 - Get JSON values quickly - JSON parser for Go
...
* [protobuf-go-lite](https://github.com/aperturerobotics/protobuf-go-lite) ⭐ 62 | 🐛 1 | 🌐 Go | 📅 2026-08-11 - Reflection-free Protobuf for Go.

## Gaming

* [koebiten](https://github.com/sago35/koebiten) ⭐ 56 | 🐛 0 | 🌐 Go | 📅 2026-07-26 - Koebiten is a 2D game engine that runs on TinyGo. Inspired by Ebitengine and is characterized by its simple API.
...
* [wasmCV](https://github.com/wasmvision/go-wasmcv) ⭐ 8 | 🐛 0 | 🌐 Assembly | 📅 2025-08-13 - Go bindings for wasmCV computer vision interfaces using WebAssembly.

## Wireless Communication

* [Go Bluetooth](https://github.com/tinygo-org/bluetooth) ⭐ 987 | 🐛 128 | 🌐 C | 📅 2026-08-04 - Go Bluetooth is a cross-platform package for using Bluetooth Low Energy hardware from the Go programming language.
* [lorawan](https://github.com/tinygo-org/drivers/tree/release/lora/lorawan) ⭐ 744 | 🐛 159 | 🌐 Go | 📅 2026-08-10 - LoRaWAN implementation for embedded devices using TinyGo.

# Awesome TinyGo Creations

**Hardware and software implementations**

* [go-haystack](https://github.com/hybridgroup/go-haystack) ⭐ 1,502 | 🐛 5 | 🌐 Go | 📅 2025-08-20 - Track personal Bluetooth devices via Apple's "Find My" network using OpenHaystack and Macless-Haystack with tools written in Go/TinyGo. No Apple hardware required!
* [wasmVision](https://github.com/wasmvision/wasmvision) ⭐ 244 | 🐛 1 | 🌐 Go | 📅 2026-02-16 - wasmVision gets you going with computer vision using WebAssembly with processors written using TinyGo/Rust/C.
* [USB HID Keyboard firmware for TinyGo](https://github.com/sago35/tinygo-keyboard) ⭐ 114 | 🐛 11 | 🌐 Go | 📅 2026-07-28 - keyboard firmware for tinygo
...
* [`u-root`](https://github.com/u-root/u-root) ⭐ 3,061 | 🐛 169 | 🌐 Go | 📅 2026-08-11 - Go versions of many standard Linux tools, such as ls, cp, or shutdown among other awesome OS stuff.
...
* [`tinystring`](https://github.com/cdvelop/tinystring) ⭐ 20 | 🐛 0 | 🌐 Go | 📅 2026-07-19 - Lightweight text manipulation library with a fluid API and no external dependencies.
