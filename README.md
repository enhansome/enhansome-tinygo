...
* [TinyGo Drivers](https://github.com/tinygo-org/drivers) ⭐ 745 | 🐛 155 | 🌐 Go | 📅 2026-08-21 - Provides a collection of hardware drivers for devices such as sensors and displays that can be used together with TinyGo.
...
* [gjson](https://github.com/tidwall/gjson) ⭐ 15,556 | 🐛 100 | 🌐 Go | 📅 2026-05-14 - Get JSON values quickly - JSON parser for Go
...
* [protobuf-go-lite](https://github.com/aperturerobotics/protobuf-go-lite) ⭐ 62 | 🐛 1 | 🌐 Go | 📅 2026-08-26 - Reflection-free Protobuf for Go.
...
* [lorawan](https://github.com/tinygo-org/drivers/tree/release/lora/lorawan) ⭐ 745 | 🐛 155 | 🌐 Go | 📅 2026-08-21 - LoRaWAN implementation for embedded devices using TinyGo.
...
* [`u-root`](https://github.com/u-root/u-root) ⭐ 3,068 | 🐛 160 | 🌐 Go | 📅 2026-08-27 - Go versions of many standard Linux tools, such as ls, cp, or shutdown among other awesome OS stuff.
* [`cbor`](https://github.com/fxamacker/cbor) ⭐ 1,081 | 🐛 30 | 🌐 Go | 📅 2026-08-26 - Library for encoding and decoding Concise Binary Object Representation data and Sequences (RFC8949).
