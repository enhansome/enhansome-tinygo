...
A curated list of awesome TinyGo projects. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 183,872 | 🐛 233 | 🌐 Go | 📅 2026-09-10.
...
* [TinyGo Drivers](https://github.com/tinygo-org/drivers) ⭐ 751 | 🐛 160 | 🌐 Go | 📅 2026-09-10 - Provides a collection of hardware drivers for devices such as sensors and displays that can be used together with TinyGo.
...
* [pio](https://github.com/tinygo-org/pio) ⭐ 51 | 🐛 12 | 🌐 Go | 📅 2026-09-12 - Programmable I/O API for RP2040/RP2350 using TinyGo
...
* [easyjson](https://github.com/mailru/easyjson) ⭐ 4,915 | 🐛 99 | 🌐 Go | 📅 2026-03-14 - Fast JSON serializer for golang.
...
* [lorawan](https://github.com/tinygo-org/drivers/tree/release/lora/lorawan) ⭐ 751 | 🐛 160 | 🌐 Go | 📅 2026-09-10 - LoRaWAN implementation for embedded devices using TinyGo.

# Awesome TinyGo Creations

**Hardware and software implementations**

* [go-haystack](https://github.com/hybridgroup/go-haystack) ⭐ 1,513 | 🐛 2 | 🌐 Go | 📅 2026-09-09 - Track personal Bluetooth devices via Apple's "Find My" network using OpenHaystack and Macless-Haystack with tools written in Go/TinyGo. No Apple hardware required!
...
* [HeadTracker](https://github.com/ysoldak/HeadTracker) ⭐ 112 | 🐛 6 | 🌐 Go | 📅 2026-06-26 - Bluetooth DIY Head Tracker, for Nano 33 BLE and XIAO BLE Sense boards.
...
* [`u-root`](https://github.com/u-root/u-root) ⭐ 3,072 | 🐛 160 | 🌐 Go | 📅 2026-09-12 - Go versions of many standard Linux tools, such as ls, cp, or shutdown among other awesome OS stuff.
* [`cbor`](https://github.com/fxamacker/cbor) ⭐ 1,088 | 🐛 28 | 🌐 Go | 📅 2026-09-04 - Library for encoding and decoding Concise Binary Object Representation data and Sequences (RFC8949).
