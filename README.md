...
A curated list of awesome TinyGo projects. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 183,775 | 🐛 233 | 🌐 Go | 📅 2026-09-10.
...
* [TinyGo Drivers](https://github.com/tinygo-org/drivers) ⭐ 750 | 🐛 159 | 🌐 Go | 📅 2026-09-10 - Provides a collection of hardware drivers for devices such as sensors and displays that can be used together with TinyGo.
...
* [pio](https://github.com/tinygo-org/pio) ⭐ 51 | 🐛 13 | 🌐 Go | 📅 2026-09-10 - Programmable I/O API for RP2040/RP2350 using TinyGo
...
* [lorawan](https://github.com/tinygo-org/drivers/tree/release/lora/lorawan) ⭐ 750 | 🐛 159 | 🌐 Go | 📅 2026-09-10 - LoRaWAN implementation for embedded devices using TinyGo.
...
* [`u-root`](https://github.com/u-root/u-root) ⭐ 3,072 | 🐛 161 | 🌐 Go | 📅 2026-09-09 - Go versions of many standard Linux tools, such as ls, cp, or shutdown among other awesome OS stuff.
