...
A curated list of awesome TinyGo projects. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 182,844 | 🐛 223 | 🌐 Go | 📅 2026-09-01.
...
* [TinyGo Drivers](https://github.com/tinygo-org/drivers) ⭐ 747 | 🐛 156 | 🌐 Go | 📅 2026-08-21 - Provides a collection of hardware drivers for devices such as sensors and displays that can be used together with TinyGo.
...
* [protobuf-go-lite](https://github.com/aperturerobotics/protobuf-go-lite) ⭐ 62 | 🐛 1 | 🌐 Go | 📅 2026-08-30 - Reflection-free Protobuf for Go.
...
* [lorawan](https://github.com/tinygo-org/drivers/tree/release/lora/lorawan) ⭐ 747 | 🐛 156 | 🌐 Go | 📅 2026-08-21 - LoRaWAN implementation for embedded devices using TinyGo.
...
* [`u-root`](https://github.com/u-root/u-root) ⭐ 3,070 | 🐛 161 | 🌐 Go | 📅 2026-09-01 - Go versions of many standard Linux tools, such as ls, cp, or shutdown among other awesome OS stuff.
* [`cbor`](https://github.com/fxamacker/cbor) ⭐ 1,081 | 🐛 28 | 🌐 Go | 📅 2026-08-30 - Library for encoding and decoding Concise Binary Object Representation data and Sequences (RFC8949).
