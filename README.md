...
A curated list of awesome TinyGo projects. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 181,450 | 🐛 213 | 🌐 Go | 📅 2026-08-18.
...
* [Go Bluetooth](https://github.com/tinygo-org/bluetooth) ⭐ 989 | 🐛 128 | 🌐 C | 📅 2026-08-04 - Go Bluetooth is a cross-platform package for using Bluetooth Low Energy hardware from the Go programming language.
...
* [go-haystack](https://github.com/hybridgroup/go-haystack) ⭐ 1,508 | 🐛 5 | 🌐 Go | 📅 2025-08-20 - Track personal Bluetooth devices via Apple's "Find My" network using OpenHaystack and Macless-Haystack with tools written in Go/TinyGo. No Apple hardware required!
...
* [`u-root`](https://github.com/u-root/u-root) ⭐ 3,065 | 🐛 169 | 🌐 Go | 📅 2026-08-17 - Go versions of many standard Linux tools, such as ls, cp, or shutdown among other awesome OS stuff.
* [`cbor`](https://github.com/fxamacker/cbor) ⭐ 1,079 | 🐛 29 | 🌐 Go | 📅 2026-08-18 - Library for encoding and decoding Concise Binary Object Representation data and Sequences (RFC8949).
