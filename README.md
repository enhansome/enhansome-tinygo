...
A curated list of awesome TinyGo projects. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 183,671 | 🐛 226 | 🌐 Go | 📅 2026-09-10.
...
* [TinyGo Drivers](https://github.com/tinygo-org/drivers) ⭐ 750 | 🐛 157 | 🌐 Go | 📅 2026-09-10 - Provides a collection of hardware drivers for devices such as sensors and displays that can be used together with TinyGo.
...
* [pio](https://github.com/tinygo-org/pio) ⭐ 51 | 🐛 16 | 🌐 Go | 📅 2026-09-09 - Programmable I/O API for RP2040/RP2350 using TinyGo
...
* [protobuf-go-lite](https://github.com/aperturerobotics/protobuf-go-lite) ⭐ 62 | 🐛 2 | 🌐 Go | 📅 2026-09-09 - Reflection-free Protobuf for Go.
...
* [Go Bluetooth](https://github.com/tinygo-org/bluetooth) ⭐ 1,004 | 🐛 126 | 🌐 C | 📅 2026-09-09 - Go Bluetooth is a cross-platform package for using Bluetooth Low Energy hardware from the Go programming language.
* [lorawan](https://github.com/tinygo-org/drivers/tree/release/lora/lorawan) ⭐ 750 | 🐛 157 | 🌐 Go | 📅 2026-09-10 - LoRaWAN implementation for embedded devices using TinyGo.

# Awesome TinyGo Creations

**Hardware and software implementations**

* [go-haystack](https://github.com/hybridgroup/go-haystack) ⭐ 1,511 | 🐛 2 | 🌐 Go | 📅 2026-09-09 - Track personal Bluetooth devices via Apple's "Find My" network using OpenHaystack and Macless-Haystack with tools written in Go/TinyGo. No Apple hardware required!
...
* [`u-root`](https://github.com/u-root/u-root) ⭐ 3,071 | 🐛 160 | 🌐 Go | 📅 2026-09-09 - Go versions of many standard Linux tools, such as ls, cp, or shutdown among other awesome OS stuff.
* [`cbor`](https://github.com/fxamacker/cbor) ⭐ 1,087 | 🐛 28 | 🌐 Go | 📅 2026-09-04 - Library for encoding and decoding Concise Binary Object Representation data and Sequences (RFC8949).
