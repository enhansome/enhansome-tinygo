...
A curated list of awesome TinyGo projects. Inspired by [awesome-go](https://github.com/avelino/awesome-go) ⭐ 184,956 | 🐛 230 | 🌐 Go | 📅 2026-09-20.
...
* [gomavlib](https://github.com/bluenviron/gomavlib) ⭐ 195 | 🐛 0 | 🌐 Go | 📅 2026-09-21 - Mavlink protocol (2.0 and 1.0) implementation in Go for control and instrumentation of autonomous vehicles.
...
* [gjson](https://github.com/tidwall/gjson) ⭐ 15,555 | 🐛 100 | 🌐 Go | 📅 2026-08-28 - Get JSON values quickly - JSON parser for Go
...
* [Go Bluetooth](https://github.com/tinygo-org/bluetooth) ⭐ 1,006 | 🐛 127 | 🌐 C | 📅 2026-09-16 - Go Bluetooth is a cross-platform package for using Bluetooth Low Energy hardware from the Go programming language.
...
* [`u-root`](https://github.com/u-root/u-root) ⭐ 3,075 | 🐛 160 | 🌐 Go | 📅 2026-09-20 - Go versions of many standard Linux tools, such as ls, cp, or shutdown among other awesome OS stuff.
